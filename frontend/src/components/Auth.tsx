  ...
  return (
    <div className="flex flex-col h-screen justify-center">
      <div className="flex justify-center">
        <div className="w-full sm:w-3/4 md:w-2/3 lg:w-1/2 px-4 sm:px-6 lg:px-8">
          <div className="px-4 sm:px-6 lg:px-10">
            <div className="text-xl sm:text-2xl md:text-3xl font-extrabold">
              {type === "signup" ? "Sign up with email" : "Sign in with email"}
            </div>
            <div className="mt-1 text-slate-400 text-sm sm:text-base">
              {type === "signup"
          ...
          <div className="mt-2 pt-2 flex flex-col">
            ...
            <button
              onClick={sendRequest}
              type="button"
              className="relative inline-block text-base sm:text-lg group mt-6 sm:mt-8"
            >
  ...
  return (
    <div className="mt-4">
      ...
      <input
        ...
        className="w-full bg-gray-300 rounded border bg-opacity-40 border-gray-700 focus:ring-2 focus:ring-gray-600 focus:bg-transparent focus:border-gray-500 text-sm sm:text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
      ></input>
    </div>
  );
}
